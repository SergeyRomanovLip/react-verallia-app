    ...
    <div className='infoWindow'>
      ...
      <div className='infoWindow-body'>
        <div className='infoWindow-body-form'>
          ...
          <hr />
          <InputRow text={'Employees quantity'} data={'quantity'} fun={addData} type={'number'} />
          <InputText text={'Works description'} data={'description'} fun={addData} />
          <InputRow text={'Company name'} data={'company'} fun={addData} type={'text'} />
          <hr />
          <div className='highlightedCheckbox-container'>
            <Checkbox text={'Fire works'} data={'fireWorks'} fun={addData} />
            <Checkbox text={'Works on height'} data={'heightWorks'} fun={addData} />
            <Checkbox text={'Electrical works'} data={'electricalWorks'} fun={addData} />
            <Checkbox text={'Works on roof'} data={'roofWorks'} fun={addData} />
            <Checkbox text={'Digging'} data={'digging'} fun={addData} />
            <Checkbox text={'Limited space'} data={'limitedSpace'} fun={addData} />
          </div>
          <div className='infoWindow-body-form'>
            <div
              onClick={() => {
